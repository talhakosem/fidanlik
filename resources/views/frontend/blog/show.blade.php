        ...
        <div class="row">
            <article class="col-lg-8 offset-lg-2">
                ...
                <div class="text-center">
                    <h1 class="mt-3 display-4 fw-bold">{{ $post->title }}</h1>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="text-center mb-6">
                    <h2 class="mb-0">İlgili Yazılar</h2>
                </div>
            </div>
        </div>
        <div class="row gy-4">
            @foreach($relatedPosts as $relatedPost)
                ...
                <div class="col-lg-4 col-md-6">
                    <article>
                        <a href="{{ url('/' . $relatedPost->slug) }}" class="position-relative d-flex">
                        ...
                        <div class="mt-4">
                            <h3 class="fs-5">
                                <a href="{{ url('/' . $relatedPost->slug) }}" class="text-inherit">
                                    {{ $relatedPost->title }}
                                </a>
                            </h3>
                            <p>{{ $relatedPost->short_description ?? \Illuminate\Support\Str::limit(strip_tags($relatedPost->content), 120) }}</p>
