...
@section('meta_description', 'Blog yazıları ve makaleler')
            ...
            <div class="col-lg-8">
                <div class="text-center">
                    ...
                    <p class="mb-0">
                        ...
                        @endphp
                        {{ $settings->site_description ?? 'En son blog yazılarımızı keşfedin' }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <article>
                        ...
                        <div class="mt-4">
                            ...
                            <p>
                                {{ $post->short_description ?? \Illuminate\Support\Str::limit(strip_tags($post->content), 150) }}
                            </p>
