        ...
        <div class="card card-lg">
            <div class="card-body p-6 d-flex flex-column gap-4">
                ...
                <div>
                    ...
                    <textarea name="content" id="content" class="d-none @error('content') is-invalid @enderror" required>{{ old('content') }}</textarea>
                    @error('content')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="card-body p-6 d-flex flex-column gap-4">
                ...
                <div>
                    ...
                    <select class="form-select @error('category') is-invalid @enderror" 
                        ...
                        <option value="Tarifler" {{ old('category') == 'Tarifler' ? 'selected' : '' }}>Tarifler</option>
                        <option value="Şirket" {{ old('category') == 'Şirket' ? 'selected' : '' }}>Şirket</option>
                        <option value="Perakende" {{ old('category') == 'Perakende' ? 'selected' : '' }}>Perakende</option>
