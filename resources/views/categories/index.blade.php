                                ...
                                <tr>
                                    <td>
                                        ...
                                        @elseif($category->icon)
                                            <div class="bg-light rounded d-flex align-items-center justify-content-center" 
                                                ...
                                                <i class="bi bi-{{ $category->icon }} text-muted"></i>
                                            </div>
                                        @else
                                            <div class="bg-light rounded d-flex align-items-center justify-content-center" 
                                                 style="width: 40px; height: 40px;">
                                    ...
                                    <td>
                                        @if($category->show_in_top_menu)
                                            <span class="badge bg-primary me-1">Üst Menü</span>
                                        @endif
                                        @if($category->show_in_footer_menu)
                                            <span class="badge bg-success">Alt Menü</span>
                                        @endif
                                        @if(!$category->show_in_top_menu && !$category->show_in_footer_menu)
                                            <span class="text-muted">-</span>
                                        @endif
                                    </td>
                                    <td>
