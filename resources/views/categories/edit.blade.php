        ...
        <div class="card card-lg">
            <div class="card-body p-6 d-flex flex-column gap-4">
                ...
                <div>
                    ...
                    <small class="form-text text-muted">Bootstrap Icons adı (örn: folder, tag)</small>
                    @error('icon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div>
                    <div class="form-check form-switch ps-0">
                        <label class="form-check-label" for="show_in_footer_menu">Alt Menüde Göster</label>
                        <input class="form-check-input ms-auto" 
                               type="checkbox" 
                               role="switch" 
                               ...
                               value="1"
                               {{ old('show_in_footer_menu', $category->show_in_footer_menu) ? 'checked' : '' }}>
                    </div>
                </div>
